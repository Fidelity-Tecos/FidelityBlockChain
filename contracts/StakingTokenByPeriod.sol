...
/**
 * @title Fidelity Token smart contract
 * @author TECOS
 * @notice Implements a basic ERC20 staking Fidelity Token.
 */
contract StakingTokenByPeriod is ERC20, Ownable {
    ...
    uint256 internal rewardsDuration = 2 minutes;
